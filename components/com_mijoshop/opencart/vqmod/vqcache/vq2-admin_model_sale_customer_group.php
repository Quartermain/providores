...
class ModelSaleCustomerGroup extends Model {
	public function addCustomerGroup($data) {
        ...
        $this->db->query("INSERT INTO " . DB_PREFIX . "jgroup_cgroup_map SET jgroup_id = '" . (int)$data['jgroup_id'] . "', cgroup_id = '" . (int)$customer_group_id . "'");
	...
	public function editCustomerGroup($customer_group_id, $data) {
        $this->db->query("UPDATE " . DB_PREFIX . "jgroup_cgroup_map SET jgroup_id = '" . (int)$data['jgroup_id'] . "' WHERE cgroup_id = '" . (int)$customer_group_id . "'");
	...
	public function deleteCustomerGroup($customer_group_id) {
        $this->db->query("DELETE FROM " . DB_PREFIX . "jgroup_cgroup_map WHERE cgroup_id = '" . (int)$customer_group_id . "'");
