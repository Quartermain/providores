        ...
        <div id="tab-store">
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="config_template" onchange="$('#template').load('index.php?option=com_mijoshop&route=setting/setting/template&token=<?php echo $token; ?>&template=' + encodeURIComponent(this.value));">
...
$('#template').load('index.php?option=com_mijoshop&route=setting/setting/template&token=<?php echo $token; ?>&template=' + encodeURIComponent($('select[name=\'config_template\']').attr('value')));
//--></script> 
<script type="text/javascript"><!--
