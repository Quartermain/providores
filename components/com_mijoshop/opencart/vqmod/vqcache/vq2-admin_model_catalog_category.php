...
class ModelCatalogCategory extends Model {
	public function addCategory($data) {
		MijoShop::get('base')->trigger('onMijoshopBeforeCategorySave', array(&$data, true)); 
        ...
        MijoShop::get('mijosef')->store($data['mijosef'], $category_id);

        $def_lang_id = Mijoshop::get('opencart')->get('config')->get('config_language_id');
        $data['keyword'] = empty($data['keyword']) ? MijoShop::get('router')->generateAlias($data['category_description'][$def_lang_id]['name']) : $data['keyword'];
		if ($data['keyword']) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "url_alias SET query = 'category_id=" . (int)$category_id . "', keyword = '" . $this->db->escape($data['keyword']) . "'");
		}

		MijoShop::get('base')->trigger('onMijoshopAfterCategorySave', array(&$data, &$category_id, true)); 
	...
	public function editCategory($category_id, $data) {
		MijoShop::get('base')->trigger('onMijoshopBeforeCategorySave', array(&$data, &$category_id, false)); 
		...
		MijoShop::get('base')->trigger('onMijoshopAfterCategorySave', array(&$data, &$category_id, false)); 
		$this->cache->delete('category');
	}

	public function deleteCategory($category_id) {
		MijoShop::get('base')->trigger('onMijoshopBeforeCategoryDelete', array(&$category_id)); 
		$this->db->query("DELETE FROM " . DB_PREFIX . "category_path WHERE category_id = '" . (int)$category_id . "'");
		...
		MijoShop::get('base')->trigger('onMijoshopAfterCategoryDelete', array(&$category_id)); 
		$this->cache->delete('category');
	} 
