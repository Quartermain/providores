...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		MijoShop::get('base')->trigger('onMijoshopBeforeManufacturerSave', array(&$data, true)); 
		...
		MijoShop::get('base')->trigger('onMijoshopAfterManufacturerSave', array(&$data, &$manufacturer_id, true)); 
		$this->cache->delete('manufacturer');
		return $manufacturer_id; 
	}
	
	public function editManufacturer($manufacturer_id, $data) {
		MijoShop::get('base')->trigger('onMijoshopBeforeManufacturerSave', array(&$data, &$manufacturer_id, false)); 
		...
		MijoShop::get('base')->trigger('onMijoshopAfterManufacturerSave', array(&$data, &$manufacturer_id, false)); 
		$this->cache->delete('manufacturer');
	}
	
	public function deleteManufacturer($manufacturer_id) {
		MijoShop::get('base')->trigger('onMijoshopBeforeManufacturerDelete', array(&$manufacturer_id)); 
		$this->db->query("DELETE FROM " . DB_PREFIX . "manufacturer WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "manufacturer_to_store WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "url_alias WHERE query = 'manufacturer_id=" . (int)$manufacturer_id . "'");
			
		MijoShop::get('base')->trigger('onMijoshopAfterManufacturerDelete', array(&$manufacturer_id)); 
		$this->cache->delete('manufacturer');
	}	
