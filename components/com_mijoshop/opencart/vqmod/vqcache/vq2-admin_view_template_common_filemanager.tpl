...
$(document).ready(function() { 
	...
	$('#column-right').bind('scrollstop', function() {
		$('#column-right a').each(function(index, element) {
			...
			if ((offset.top > 0) && (offset.top < height) && $(element).find('img').attr('src') == '<?php echo $no_image; ?>') {
				$.ajax({
					url: 'index.php?option=com_mijoshop&format=raw&tmpl=component&route=common/filemanager/image&token=<?php echo $token; ?>&image=' + encodeURIComponent('data/' + $(element).find('input[name=\'image\']').attr('value')),
					dataType: 'html',
	...
	$('#column-left').tree({
		data: { 
			...
			opts: { 
				method: 'post', 
				url: 'index.php?option=com_mijoshop&format=raw&tmpl=component&route=common/filemanager/directory&token=<?php echo $token; ?>'
			} 
		},
		selected: 'top',
		ui: {		
		...
		callback: {
			...
			onselect: function (NODE, TREE_OBJ) {
				$.ajax({
					url: 'index.php?option=com_mijoshop&format=raw&tmpl=component&route=common/filemanager/files&token=<?php echo $token; ?>',
					type: 'post',
	...
	$('#create').bind('click', function() {
		...
		if (tree.selected) {
			...
			$('#dialog input[type=\'button\']').bind('click', function() {
				$.ajax({
					url: 'index.php?option=com_mijoshop&format=raw&tmpl=component&route=common/filemanager/create&token=<?php echo $token; ?>',
					type: 'post',
	...
	$('#delete').bind('click', function() {
		...
		if (path) {
			$.ajax({
				url: 'index.php?option=com_mijoshop&format=raw&tmpl=component&route=common/filemanager/delete&token=<?php echo $token; ?>',
				type: 'post',
	...
	$('#move').bind('click', function() {
		...
		$('#dialog select[name=\'to\']').load('index.php?option=com_mijoshop&format=raw&tmpl=component&route=common/filemanager/folders&token=<?php echo $token; ?>');
		...
		$('#dialog input[type=\'button\']').bind('click', function() {
			...
			if (path) {																
				$.ajax({
					url: 'index.php?option=com_mijoshop&format=raw&tmpl=component&route=common/filemanager/move&token=<?php echo $token; ?>',
					type: 'post',
	...
	$('#copy').bind('click', function() {
		...
		$('#dialog input[type=\'button\']').bind('click', function() {
			...
			if (path) {																
				$.ajax({
					url: 'index.php?option=com_mijoshop&format=raw&tmpl=component&route=common/filemanager/copy&token=<?php echo $token; ?>',
					type: 'post',
	...
	$('#rename').bind('click', function() {
		...
		$('#dialog input[type=\'button\']').bind('click', function() {
			...
			if (path) {		
				$.ajax({
					url: 'index.php?option=com_mijoshop&format=raw&tmpl=component&route=common/filemanager/rename&token=<?php echo $token; ?>',
					type: 'post',
					data: 'path=' + encodeURIComponent(path) + '&name=' + encodeURIComponent($('#dialog input[name=\'name\']').val()),
					dataType: 'json',
					success: function(json) {
	...
	new AjaxUpload('#upload', {
		action: 'index.php?option=com_mijoshop&format=raw&tmpl=component&route=common/filemanager/upload&token=<?php echo $token; ?>',
		name: 'image',
		autoSubmit: false,
		responseType: 'json',
