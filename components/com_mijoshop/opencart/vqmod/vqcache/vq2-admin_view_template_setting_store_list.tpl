...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a href="<?php echo $insert; ?>" class="button"><?php echo $button_insert; ?></a><a onclick="$('form').submit();" class="button"><?php echo $button_delete; ?></a><a onclick="fixIds();" class="button"><?php echo $button_fix_lang_ids; ?></a><a onclick="fix();" class="button"><?php echo $button_lang_sync; ?></a></div>
    </div>
    <div class="content">
