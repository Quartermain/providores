...
class ControllerCommonHeader extends Controller {
	protected function index() {
        ...
        $this->data['text_support_oc'] = $this->language->get('text_support_oc');
		...
		$this->data['text_vqmod_manager'] = $this->language->get('text_vqmod_manager');
          $this->data['text_themeeditor'] = $this->language->get('text_themeeditor');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
          ...
          $this->data['themeeditor'] = $this->url->link('tool/themeeditor', 'token=' . $this->session->data['token'], 'SSL');
          ...
          $this->data['support'] = $this->url->link('common/support', '', 'SSL');
          ...
          $this->data['upgrade'] = $this->url->link('common/upgrade', 'token=' . $this->session->data['token'], 'SSL');
