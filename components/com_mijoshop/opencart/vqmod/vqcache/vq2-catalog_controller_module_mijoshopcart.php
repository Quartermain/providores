...
class ControllerModuleMijoshopcart extends Controller { 
	public function index() {
		...
		if (file_exists(JPATH_ROOT.'/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/module/mijoshopcart.tpl')) {
            $this->template = '/templates/'.MijoShop::getTmpl().'/html/com_mijoshop/module/mijoshopcart.tpl';
        }
        else if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/mijoshopcart.tpl')) {
