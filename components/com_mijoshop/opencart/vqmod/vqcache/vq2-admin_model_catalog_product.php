...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		MijoShop::get('base')->trigger('onMijoshopBeforeProductSave', array(&$data, true)); 
        ...
        $data['keyword'] = empty($data['keyword']) ? MijoShop::get('router')->generateAlias($data['product_description'][$def_lang_id]['name']) : $data['keyword'];
		if (isset($data['keyword'])) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "url_alias SET query = 'product_id=" . (int)$product_id . "', keyword = '" . $this->db->escape($data['keyword']) . "'");
		}
						
		MijoShop::get('base')->trigger('onMijoshopAfterProductSave', array(&$data, &$product_id, true)); 
	...
	public function editProduct($product_id, $data) {
		MijoShop::get('base')->trigger('onMijoshopBeforeProductSave', array(&$data, &$product_id, false)); 
        ...
        MijoShop::get('mijosef')->store($data['mijosef'], $product_id);
		...
		MijoShop::get('base')->trigger('onMijoshopAfterProductSave', array(&$data, &$product_id, false)); 
		$this->cache->delete('product');
	}
	...
	public function deleteProduct($product_id) {
		MijoShop::get('base')->trigger('onMijoshopBeforeProductDelete', array(&$product_id)); 
		...
		MijoShop::get('base')->trigger('onMijoshopAfterProductDelete', array(&$product_id)); 
		$this->cache->delete('product');
	}
