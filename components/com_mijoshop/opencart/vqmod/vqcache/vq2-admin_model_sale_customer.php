...
class ModelSaleCustomer extends Model {
	...
	public function editCustomer($customer_id, $data) {
		MijoShop::get('user')->updateJUserFromO(MijoShop::get('user')->getJUserIdFromOCustomer($customer_id), $data, $customer_id);
	...
	public function deleteCustomer($customer_id) {
		MijoShop::get('user')->deleteJUserFromO($customer_id);
	...
	public function approve($customer_id) {
		...
		if ($customer_info) {
            MijoShop::get('user')->approveJUserFromO($customer_id);
