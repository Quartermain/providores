...
<div id="content"><?php echo $content_top; ?>
  <div class="box">
  <div class="box-heading"><h1 class="mijoshop_heading_h1"><?php echo $heading_title; ?><?php if ($weight) { ?>
    &nbsp;(<?php echo $weight; ?>)
    <?php } ?></h1></div>
  ...
  <div class="cart-module">
    <div id="coupon" class="content" style="display: <?php echo ($next == 'coupon' ? 'block' : 'none'); ?>;">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        ...
        &nbsp;
        <input type="submit" value="<?php echo $button_coupon; ?>" class="<?php echo MijoShop::getButton(); ?>" />
      </form>
    </div>
    <div id="voucher" class="content" style="display: <?php echo ($next == 'voucher' ? 'block' : 'none'); ?>;">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        ...
        &nbsp;
        <input type="submit" value="<?php echo $button_voucher; ?>" class="<?php echo MijoShop::getButton(); ?>" />
      </form>
    </div>
    <div id="reward" class="content" style="display: <?php echo ($next == 'reward' ? 'block' : 'none'); ?>;">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        ...
        &nbsp;
        <input type="submit" value="<?php echo $button_reward; ?>" class="<?php echo MijoShop::getButton(); ?>" />
      </form>
    </div>
    <div id="shipping" class="content" style="display: <?php echo ($next == 'shipping' ? 'block' : 'none'); ?>;">
      ...
      <input type="button" value="<?php echo $button_quote; ?>" id="button-quote" class="<?php echo MijoShop::getButton(); ?>" />
    </div>
  </div>
  <?php } ?>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				...
				html += '  <input type="submit" value="<?php echo $button_shipping; ?>" id="button-shipping" class="<?php echo MijoShop::getButton(); ?>" />';	
				<?php } else { ?>
				html += '  <input type="submit" value="<?php echo $button_shipping; ?>" id="button-shipping" class="<?php echo MijoShop::getButton(); ?>" disabled="disabled" />';	
				<?php } ?>
