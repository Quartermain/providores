      ...
      <div class="options">
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <table class="option-image">
            <?php foreach ($option['option_value'] as $option_value) { ?>
            <tr>
              <td style="width: 1px;"><input type="radio" name="option_oc[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" /></td>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <b><?php echo $option['name']; ?>:</b><br />
          <input type="text" name="option_oc[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['option_value']; ?>" class="date" />
        </div>
        <br />
        <?php } ?>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <b><?php echo $option['name']; ?>:</b><br />
          <input type="text" name="option_oc[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['option_value']; ?>" class="datetime" />
        </div>
        <br />
        <?php } ?>
