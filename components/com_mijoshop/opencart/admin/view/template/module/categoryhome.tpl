    ...
    <table id="module" class="list">
      ...
      <?php $module_row = 0; ?>
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            <td class="left"><select name="categoryhome_module[<?php echo $module_row; ?>][parent_cat_id]">
                <?php foreach ($categories as $category) { ?>
                <?php if ($category['category_id'] == $module['parent_cat_id']) { ?>
                <option value="<?php echo $category['category_id']; ?>" selected="selected"><?php echo $category['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $category['category_id']; ?>"><?php echo $category['name']; ?></option>
                <?php } ?>
                <?php } ?>
              </select></td><td class="left"><select name="categoryhome_module[<?php echo $module_row; ?>][layout_id]">
...
function addModule() {	
	...
	html += '  <tr>';
    html += '    <td class="left"><select name="categoryhome_module[' + module_row + '][parent_cat_id]">';
    <?php foreach ($categories as $category) { ?>
