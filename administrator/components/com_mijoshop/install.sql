...
INSERT IGNORE INTO `#__mijoshop_banner_image` (`banner_image_id`, `banner_id`, `link`, `image`) VALUES
...
INSERT IGNORE INTO `#__mijoshop_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`) VALUES
(33, 1, 'Cameras', '', '', '');
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=2;

INSERT IGNORE INTO `#__mijoshop_customer_group` (`customer_group_id`, `approval`, `company_id_display`, `company_id_required`, `tax_id_display`, `tax_id_required`, `sort_order`) VALUES
(1, 0, 1, 0, 0, 1, 1);
...
/* V155 cahanged mijoshop_customer_blacklist_ip to mijoshop_customer_ban_id */
...
INSERT IGNORE INTO `#__mijoshop_information_description` (`information_id`, `language_id`, `title`, `description`) VALUES
(4, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n'),
...
DROP TABLE IF EXISTS `#__mijoshop_manufacturer_to_store`;
...
INSERT IGNORE INTO `#__mijoshop_option_value` (`option_value_id`, `option_id`, `sort_order`) VALUES
(43, 1, 3),
(32, 1, 1),
(45, 2, 4),
(44, 2, 3),
...
CREATE TABLE IF NOT EXISTS `#__mijoshop_order_download` (
...
CREATE TABLE IF NOT EXISTS `#__mijoshop_order_misc` (
  `order_id` int(11) NOT NULL,
...
INSERT IGNORE INTO `#__mijoshop_product_description` (`product_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`) VALUES
...
INSERT IGNORE INTO `#__mijoshop_product_image` (`product_image_id`, `product_id`, `image`) VALUES
...
INSERT IGNORE INTO `#__mijoshop_product_option` (`product_option_id`, `product_id`, `option_id`, `option_value`, `required`) VALUES
(226, 30, 5, '', 1);
...
INSERT IGNORE INTO `#__mijoshop_product_related` (`product_id`, `related_id`) VALUES
(30, 31);
...
CREATE TABLE IF NOT EXISTS `#__mijoshop_product_tag` (
...
INSERT IGNORE INTO `#__mijoshop_product_tag` (`product_tag_id`, `product_id`, `language_id`, `tag`) VALUES
(341, 30, 1, 'test 1'),
(342, 30, 1, 'test 2');
...
INSERT IGNORE INTO `#__mijoshop_setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES
...
INSERT IGNORE INTO `#__mijoshop_zone` (`zone_id`, `country_id`, `code`, `name`, `status`) VALUES
...
INSERT IGNORE INTO `#__mijoshop_category_path` (`category_id`, `path_id`, `level`) VALUES ('33', '33', '0');
